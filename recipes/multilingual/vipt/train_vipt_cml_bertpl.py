...
wandb.run.name = "VIPT-CML-PL-BERT"
wandb.run.save()

CURRENT_PATH = os.path.dirname(os.path.abspath(__file__))

# Name of the run for the Trainer
RUN_NAME = "VIPT-CML-PL-BERT"
...
pt_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes.csv",
    meta_file_val="",
...
pl_config = BaseDatasetConfig(
    formatter="cml_tts_phonemes",
    dataset_name="cml_tts",
    meta_file_train="train90_phonemes.csv",
    meta_file_val="",
...
model_args = VitsArgs(
    ...
    use_plbert=True,
    plbert_model_path="/raid/alefiury/translation/Coqui-TTS-Mod/TTS/bertpl",
    plbert_embedding_dim=768,
)
