...
wandb.run.name = "VIPT-CML-XPhoneBERT"
wandb.run.save()

CURRENT_PATH = os.path.dirname(os.path.abspath(__file__))

# Name of the run for the Trainer
RUN_NAME = "VIPT-CML-XPhoneBERT"

# Path where you want to save the models outputs (configs, checkpoints and tensorboard logs)
OUT_PATH = os.path.dirname(os.path.abspath(__file__))  # "/raid/coqui/Checkpoints/original-YourTTS/"

RESTORE_PATH = "/raid/alefiury/translation/Coqui-TTS-Mod/recipes/multilingual/vipt/checkpoints_yourtts_cml_tts_dataset/best_model.pth"
...
CML_DATASET_PATH = "/raid/fred/DATASETS/"
...
libritts_config = BaseDatasetConfig(
    formatter="libri_tts_r_phonemes",
...
pt_config = BaseDatasetConfig(
    formatter="cml_tts_phonemes",
    dataset_name="cml_tts",
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
...
pl_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_polish_flac_v0.1/"),
    language="pl",
)
...
it_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_italian_flac_v0.1/"),
    language="it",
)
...
fr_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_french_flac_v0.1/"),
    language="fr",
)
...
du_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_dutch_flac_v0.1/"),
    language="du",
)
...
ge_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_german_flac_v0.1/"),
    language="ge",
)
...
sp_config = BaseDatasetConfig(
    ...
    meta_file_train="train_phonemes_xphonebert.csv",
    meta_file_val="",
    path=os.path.join(CML_DATASET_PATH, "cml_tts_dataset_spanish_flac_v0.1/"),
    language="sp",
)
...
# DATASETS_CONFIG_LIST = [pt_config]
...
test_sentences_paths = [
    ...
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_portuguese_v0.1", "test/audio/3050/2941/3050_2941_000019-0001.wav"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_french_flac_v0.1", "test/audio/2223/1745/2223_1745_000039.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_french_flac_v0.1", "test/audio/2223/1745/2223_1745_000039.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_french_flac_v0.1", "test/audio/2223/1745/2223_1745_000039.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_spanish_flac_v0.1", "test/audio/3468/1378/3468_1378_000036-0001.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_spanish_flac_v0.1", "test/audio/3468/1378/3468_1378_000036-0001.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_spanish_flac_v0.1", "test/audio/3468/1378/3468_1378_000036-0001.flac"),
    os.path.join(CML_DATASET_PATH, "cml_tts_dataset_polish_flac_v0.1", "test/audio/1889/1447/1889_1447_000033.flac")
]
...
config = VitsConfig(
    ...
    run_name=RUN_NAME,
    project_name="VIPT-CML-XPhoneBERT",
    run_description="""
            - - VIPT training using CML-TTS and LibriTTS datasets
        """,
    dashboard_logger="tensorboard",
    logger_uri=None,
    run_eval_steps=5000, # remove , default: 1000
    epochs=100000,
    audio=audio_config,
...
# RESTORE_PATH = "/raid/alefiury/translation/Coqui-TTS-Mod/recipes/multilingual/vipt/VIPT-CML-XPhoneBERT-July-01-2024_02+12PM-36c6b3554/checkpoint_60000.pth"
...
trainer = Trainer(
    TrainerArgs(skip_train_epoch=SKIP_TRAIN_EPOCH),
    config,
    output_path=OUT_PATH,
    model=model,
    train_samples=train_samples,
